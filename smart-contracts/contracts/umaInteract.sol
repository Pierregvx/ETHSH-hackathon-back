...
//polygon 0xeE3Afe347D5C74317041E2618C49534dAf887c24
    ...
    enum State {NOT_INITIALISATED,VOTE_ONGOING,REFUSED,ACCEPTED}
    ...
    mapping(string=>Proposal) propDetails;
    ...
    function requestData(string memory IPFSHash ) public {
        ...
        IERC20 bondCurrency = IERC20(0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa); // Use Görli WETH as the bond currency.
    ...
    //polygon 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619
        ...
        propDetails[IPFSHash] = Proposal(requestTime,ancillaryData,State.VOTE_ONGOING);
    ...
    function settleRequest(string memory IPFSHash) public {
        Proposal memory prop = propDetails[IPFSHash];
    ...
    function updatePropState(string memory IPFSHash)public {
        if (propDetails[IPFSHash].time==0) return;
    ...
    function getPropInfos(string memory IPFSHash)public view returns(Proposal memory){
        return propDetails[IPFSHash];
    }
}
