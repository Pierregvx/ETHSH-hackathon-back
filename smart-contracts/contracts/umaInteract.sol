...
contract umaInteract {
    ...
    OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0x255483434aba5a75dc60c1391bB162BCd9DE2882);
    ...
    function requestData(string memory IPFSHash) public {
        ...
        IERC20 bondCurrency = IERC20(0x4200000000000000000000000000000000000006); // Use Görli WETH as the bond currency.
